...
# Sort using FIP
output = stocks.sort_values(rm[1], ascending = False)[:pickStocks].reset_index().rename(columns = {'index':'symbol'})
...
if saveResults == True:
    fileName = './OutputMonthly/' + dates['endDate'] + '_' + U + '_' + LB + '_lookback' + '.csv'
