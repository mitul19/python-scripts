...
outputSell = stocksSell.sort_values(rm[1], ascending = True)[:pickStocks].reset_index().rename(columns = {'index':'symbol'})
...
if saveResults == True:
    fileName = './OutputMonthly/' + dates['endDate'] + '_' + U + '_' + LB + '_lookback' + 'full.csv'
    fileNameBuy = './OutputMonthly/' + dates['endDate'] + '_' + U + '_' + LB + '_lookback' + 'buy.csv'
    fileNameSell = './OutputMonthly/' + dates['endDate'] + '_' + U + '_' + LB + '_lookback' + 'sell.csv'
